...
This project is a Python-based web scraper with a Flask web interface.
...
## Development
- Scraper Logic: `main.py`
- Web Server Entrypoint: `app.py`
- Templates: `templates/index.html`
- Run the web app: `python app.py` (access at `http://127.0.0.1:5000`)
- When scraping, always add delay/rate-limiting to avoid overwhelming targets.
